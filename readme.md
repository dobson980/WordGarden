...
WordGarden is a SwiftUI application that helps users practice spelling and word recognition through a fun and interactive word guessing game. Players guess letters to uncover hidden words, with a flower image that wilts as incorrect guesses are made.

## Features

- **Interactive Word Guessing**: Guess letters to uncover hidden words.
- **Visual Feedback**: Incorrect guesses cause the flower to wilt.
- **Sound Effects**: Correct and incorrect guesses trigger sound effects.
- **Multiple Words**: Includes a variety of words to guess from.

## Screenshots

![WordGarden](screenshots/demo.gif)
...
### Main View
The ContentView is the main view of the app where users can guess letters to uncover a hidden word and see visual feedback of their progress.

## Code Overview

### WordGardenApp
WordGardenApp is the entry point of the app.
```swift
import SwiftUI
...
### ContentView
ContentView sets up the main view with a word guessing game, visual feedback, and input fields for users to guess letters.
```swift
import SwiftUI
import AVFAudio
